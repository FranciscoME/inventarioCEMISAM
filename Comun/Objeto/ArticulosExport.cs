...
namespace Comun.Objeto
{
    public class ArticulosExport
    {
        ...
        public ArticulosExport(string _claveCabms, string _descripcion, string _costoUnitario, string _clavePresupuestal, string _nombreDelResguardatario, string _estadoFisicoDelBien)
            {
